...
class Leaderboard(QWidget):
    def __init__(self, gameController):
        ...
        image_path = "res/leaderboard_v1.png"
    ...
    def updateBoard(self):
        ...
        leaderboard_data = sorted(self.controller.players, key=lambda p: p.points, reverse=True)
        ...
        for i in range(max_players):
            ...
            if i < len(leaderboard_data):
                ...
                if player.isKeyboard:
                    image_path = "res/V0/keyboard.png"
                else:
                    if player.controllerConnected:
                        image_path = "res/V0/connected.png"
                    else:
                        # ToDo: blinking of warningLights
                        if self.waringLightOn:
                            image_path = "res/V0/disconnected-lightOn.png"
                        else:
                            image_path = "res/V0/disconnected.png"
